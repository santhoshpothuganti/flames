...
import { BackendOutputStorageStrategy, ConstructFactory, FunctionResources, ResourceProvider, StackProvider } from '@aws-amplify/plugin-types';
 ...
 */
export declare class AmplifyStorage extends Construct implements ResourceProvider<StorageResources>, StackProvider {
